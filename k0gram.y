...
postfix_expr
    ...
    | postfix_expr DEC {struct tree *kids[10] = {$1,$2}; $$ = alctree(PR_POST_FIX_INC, "postfix_expr", 2, kids, NULL);}
    ...
    | postfix_expr LPAREN function_call_values_list RPAREN {struct tree *kids[10] = {$1,$2,$3,$4}; $$ = alctree(PR_FUNCTION_CALL, "postfix_expr", 4, kids, NULL); }
    ;
